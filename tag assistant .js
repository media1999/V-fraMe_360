            ...
            this.B = async () => {
                try {
                    if ((await this.g.fetch("https://www.googletagmanager.com/gtag/js?id=DUMMY", {
                        ...
                        return v;
                    let b = await (await this.g.fetch("https://www.googletagmanager.com/gtag/js?id=DUMMY")).text();
...
*/
 ...
 SPDX-License-Identifier: Apache-2.0
*/
    var N = globalThis.trustedTypes, O;
    function ha() {
        var a = null;
        if (!N)
            return a;
                ...
                if (b instanceof Node) {
                    ...
                    do {
                        if (c instanceof Element) {
                            let H = c.classList ? [...c.classList].join(".") : ""
                    ...
                    var h;
                    let l = (h = (e = b.toString().match(/\[object (\w+)\]/)) == null ? void 0 : e[1]) != null ? h : b.toString()
                      , n = a.join(" > ");
                    return n ? `${l}: ${n}` : l
                }
                k = {};
    ...
    ;var U = function(a) {
        var b = a.g["google.tagmanager.ta.prodqueue"];
        if (b) {
            T(a, [...b]);
            var c = b.push;
            b.push = (...d) => {
    ...
    function V(a) {
        if (a == null || a.length === 0)
            return !1;
        a = Number(a);
        var b = (new Date(Date.now())).getTime();
    ...
    ;var la = function(a) {
        var b = a.g.document.documentElement.getAttribute("data-tag-assistant-prod-present");
        if (V(b))
            a.startProdDebug();
        else {
            let c = d => {
